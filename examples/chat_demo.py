...
async def main():
    ...
    system_msg = (
        ...
        f"\nUse base_dir: '{base_dir}' for all file operations and do not write outside it.\n"
        "Always call the correct tool instead of guessing."
    )
    ...
    while True:
        ...
        agent_message = str(response[0]) if response else "No response"
        chat_history.add_assistant_message(agent_message)
